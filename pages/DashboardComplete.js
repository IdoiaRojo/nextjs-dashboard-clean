...
const DashboardComplete = ({ dashboardDataInitial, usersInitial, t }) => {
            ...
            <Grid.Row cards={true}>
              {dashboardData &&
                <Grid.Col className="section" lg={12}>
                  ...
                  <ChartContentView data_api={dashboardData.data.content_view} loading={loadingCharts} />
                </Grid.Col>
              }
              {dashboardData &&
                <Grid.Col className="section" lg={12}>
                  <h3 className="sectitle">Chat sessions</h3>
                  <ChartChat data_api={dashboardData.data.chat} loading={loadingCharts} />
                </Grid.Col>
              }
              {dashboardData &&
                <Grid.Col className="section" lg={12}>
                  <h3 className="sectitle">Video session validated</h3>
                  <ChartVideo data_api={dashboardData.data.video} loading={loadingCharts} />
                </Grid.Col>
              }
              {usersData &&
                <Grid.Col className="section" lg={12}>
...
export default withTranslation('common')(DashboardComplete);
